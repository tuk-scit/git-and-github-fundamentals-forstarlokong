package com.lokongsapplication.app.modules.geolocation.`data`.model
...
data class GeoLocationModel(
   ...
   */
  var txtGroupSixtyFour: String? = MyApp.getInstance().resources.getString(R.string.lbl_hme)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtGroupSixtyFive: String? = MyApp.getInstance().resources.getString(R.string.lbl_mamacare)
  ,
  /**
   * TODO Replace with dynamic value
   */
